                ...
                <div class="card-body">
                  <form id="fileform" method="POST" enctype="multipart/form-data">
                    <div class="text-center">
                      <img src="<?php echo base_url('assets/img/profile/'.$this->session->userdata('foto'))?>" alt="" style="width: 200px;height: 200px" class="img-thumbnail rounded-circle mb-4">
                      <div class="row form-group">
                          <label class="col-md-3 text-md-right">Foto</label>
                          <div class="col-md-9">
                            <div class="custom-file">
                              <input type="file" id="gambar" name="gambar" class="form-control-file" onchange="tombol()">
                            </div>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                          ...
                          <input value="<?php echo $this->session->userdata('username') ?>" onchange="tombol()" name="username" id="username" type="text" class="form-control" placeholder="Username">
                        </div>
                      </div>
                    </div>
                    <div class="row form-group">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                          ...
                          <input value="<?php echo $this->session->userdata('nama'); ?>" onchange="tombol()" name="nama" id="nama" type="text" class="form-control" placeholder="Nama Anda">
                        </div>
                      </div>
                    </div>
                    <hr>
  ...
  <!-- End of Page Wrapper -->
    ...
    <script>
      ...
      fileform.addEventListener("submit", function(event){
        ...
        xhr.open("POST","<?php echo site_url('Controller_forum/simpansuntingprofile/'.$this->session->userdata('id')); ?>",true);
        xhr.send(fd);
        if (document.getElementById("gambar").files.length != 0){
          $('#loadingModal').modal('show');
          xhr.addEventListener('load', function(){
            document.getElementById('loading').innerHTML = '<i class="fa fa-check fa-5x"></i>&nbsp;&nbsp;&nbsp;Foto berhasil terunggah';
            setTimeout(function(){
              window.location.replace("<?php echo site_url('suntingprofile'); ?>");
            }, 3000);
          });
        }else{
          window.location.replace("<?php echo site_url('suntingprofile'); ?>");
