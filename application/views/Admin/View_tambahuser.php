              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body pb-2">
                    <form action="<?php echo site_url('admin/simpanuser') ?>" method="POST">
                      <div class="row form-group">
                          <label class="col-md-4 text-md-right" for="username">Username</label>
                          <div class="col-md-8">
                              <input type="text" id="username" autocomplete="off" name="username" class="form-control" placeholder="Username" required>
                          </div>
                      </div>
                      <div class="row form-group">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-md-8">
                          <input type="text" name="nama" autocomplete="off" class="form-control" placeholder="Nama" required>
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-md-8">
                          <div class="custom-control custom-radio">
                            <input value="1" type="radio" id="kurikulum" name="level" class="custom-control-input" required>
