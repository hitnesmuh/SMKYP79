...
<head>
  ...
  <title>Bobot Tabel Pelatihan</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                  <h3 class="m-0 font-weight-bold text-primary">Bobot Tabel Pelatihan</h3>
                </div>
                <div class="col-auto">
                ...
                <table class="table table-striped" id="dataTable1" width="100%" cellspacing="0">
                  <thead class="text-center">
                    <tr>
                      ...
                      <th class="align-middle">Judul Pelatihan</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle"><?php echo $datpelatihan->judul; ?></td>
