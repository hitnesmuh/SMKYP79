        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                  <h3 class="m-0 font-weight-bold text-primary">Daftar <i>Stopword</i></h3>
                </div>
                  <div class="col-auto">
                    <a href="<?php echo site_url('admin/tambahstopword') ?>" class="btn btn-sm btn-primary btn-icon-split">
                        <span class="icon">
            ...
            <div class="card-body">
              <p class="text-justify"><i>Stopword</i> adalah kata umum (<i>common words</i>) yang biasanya muncul dalam jumlah besar dan dianggap tidak memiliki makna. Contoh <i>stopword</i> adalah <b>yang</b>, <b>di</b>, <b>ke</b>, <b>adalah</b>, dan <b>memang</b></p>
              <div class="table-responsive">
                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                  <thead class="text-center">
                    <tr>
                      <th class="align-middle">No</th>
                      <th class="align-middle">Kata</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle"><?php echo $datstop->kata; ?></td>
                      <td class="align-middle text-center">
                        <a href="#" onclick="hapus('<?php echo $datstop->kata ?>','<?php echo $datstop->id ?>')" class="btn btn-danger btn-circle m-1"><i class="fa fa-fw fa-trash"></i></a>
                        <a href="<?php echo site_url('admin/suntingstopword/'.$datstop->id) ?>" class="btn btn-success btn-circle m-1"><i class="fa fa-fw fa-edit"></i></a>
                      </td>
                    </tr>
                    <?php
                        $no++; }
  ...
  <script>
    ...
    ?> 
      function hapus(kata, id) {
        ...
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_admin/hapusstopword/') ?>"+id);
        }else{
          return false;
        }
      }
