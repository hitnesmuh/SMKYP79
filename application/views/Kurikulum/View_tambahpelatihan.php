                ...
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <div class="row">
                      ...
                      <div class="col-auto">
                        <a href="<?php echo site_url('kurikulum/tampilpelatihan') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                          <span class="icon">
                  ...
                  <div class="card-body pb-2">
                    <form enctype="multipart/form-data" method="post" id="submitfile">
                      <div class="row form-group">
                          <label class="col-md-4 text-md-right" for="username">Kategori</label>
                          <div class="col-md-8">
                            <select name="kategori" class="custom-select" id="kategori" required>
                              <?php
                                foreach ($kategori as $datkategori) { ?>
                                  <option value="<?php echo $datkategori->id ?>"><?php echo $datkategori->nama ?></option>
                              <?php } ?>
                            </select>
                          </div>
                      </div>
                      <div class="row form-group">
                        <label class="col-md-4 text-md-right" for="password_baru">Judul</label>
                        <div class="col-md-8">
                          <input id="judul" type="text" autocomplete="off" class="form-control" name="judul" placeholder="Judul Pelatihan" required>
                        </div>
                      </div>
                      <div class="row form-group">
                        <label class="col-md-4 text-md-right" for="konfirmasi_password">Waktu</label>
                        <div class="col-md-8">
                          <input type="date" id="waktu" class="form-control" name="waktu" required>
                        </div>
                      </div>
                      <hr>
                      <div class="row form-group">
                        <label class="col-md-4 text-md-right" for="nama">Deskripsi</label>
                        <div class="col-md-8">
                          <textarea class="form-control" id="deskripsi" name="deskripsi" placeholder="Tulis deskripsi mengenai pelatihan yang ingin Anda ajukan" rows="4" required></textarea>
                        </div>
                      </div>
                      <div class="row form-group">
      ...
      var form = document.forms.namedItem("submitfile");
        form.addEventListener('submit', function(e){
            ...
            if(isi.files.length != 0){
              var konfirmasi = confirm("Apakah Anda yakin akan menggunggah berkas pelatihan ini untuk diajukan?");
              if (konfirmasi) {
                ...
                xhr.open("POST","<?php echo site_url('kurikulum/simpanpelatihan') ?>", true);
                xhr.send(fd);
                ...
                xhr.addEventListener('load', function(){
                  ...
                  setTimeout(function(){
                    ...
                    window.location.replace("<?php echo site_url('kurikulum/tampilpelatihan') ?>");
                  }, 3000);
                });
              }
            }else{
