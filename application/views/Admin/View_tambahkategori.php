              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body pb-2">
                    Kategori digunakan untuk mengelompokkan pelatihan dan forum.
                    <form action="<?php echo site_url('admin/simpankategori') ?>" method="POST">
                      <div class="row form-group mt-3">
                          <label class="col-md-4 text-md-right" for="username">Nama</label>
                          <div class="col-md-8">
                              <input type="text" id="username" autocomplete="off" name="nama" class="form-control" placeholder="Nama Kategori" required>
                          </div>
                      </div>
