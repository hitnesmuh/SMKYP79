                ...
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <div class="row">
                      ...
                      <div class="col-auto">
                        <a href="<?php echo site_url('kurikulum/tampilforum') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                          <span class="icon">
                  ...
                  <div class="card-body pb-2">
                    <form action="<?php echo site_url('kurikulum/simpanforum') ?>" method="POST">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-md-8">
                          <input id="judul" type="text" autocomplete="off" class="form-control" name="nama" placeholder="Nama Forum" required>
                        </div>
                      </div>
