                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <img style="width:60px;height:60px" src="<?php echo base_url('assets/img/profile/'.$datuser->foto) ?>" alt="" class="rounded-circle">
                      </td>
                      <td class="align-middle"><?php echo $datuser->nama; ?></td>
                      <td class="align-middle"><?php echo $datuser->username; ?></td>
                      <td class="align-middle"><?php echo $datuser->password; ?></td>
                      <td class="align-middle"><?php echo $jabatan = ($datuser->level == 1) ? "Kurikulum" : "Guru"; ?></td>
                      <td class="align-middle text-center">
                        <a href="#" onclick="hapus('<?php echo $datuser->username ?>','<?php echo $datuser->id ?>')" class="btn btn-danger btn-circle m-1"><i class="fa fa-fw fa-trash"></i></a>
                        <a href="<?php echo site_url('admin/suntinguser/'.$datuser->id) ?>" class="btn btn-success btn-circle m-1"><i class="fa fa-fw fa-edit"></i></a>
                      </td>
                    </tr>
                    <?php
                        $no++; }
  ...
  <script>
    ...
    ?> 
      function hapus(username, id) {
        ...
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_admin/hapususer/') ?>"+id);
        }else{
          return false;
        }
      }
