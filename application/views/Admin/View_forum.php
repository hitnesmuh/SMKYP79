        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                  <h3 class="m-0 font-weight-bold text-primary">Permintaan Forum</h3>
                </div>
              </div>
                ...
                <table class="table table-striped" id="dataTable1" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle"><?php echo $datforum->pembuat; ?></td>
                      <td class="align-middle text-center">
                        <a href="#" onclick="acc('<?php echo $datforum->nama ?>', '<?php echo $datforum->id ?>')" class="btn btn-success btn-circle m-1"><i class="fa fa-fw fa-check"></i></a>
                        <a href="#" onclick="tolak('<?php echo $datforum->nama ?>', '<?php echo $datforum->id ?>')" class="btn btn-danger btn-circle m-1"><i class="fa fa-fw fa-times"></i></a>
                      </td>
                    </tr>
                    <?php
                        $no++; }}
  ...
  <script>
    ...
    ?>
      function acc(judul, id) {
        var konfirmasi = confirm("Apakah Anda yakin akan acc forum " + judul);
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_admin/aksiforum/acc/') ?>" + id);
        }else{
          return false;
        }
      }
      ...
      function tolak(judul, id) {
        var konfirmasi = confirm("Apakah Anda yakin akan menolak forum " + judul);
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_admin/aksiforum/tolak/') ?>" + id);
        }else{
          return false;
        }
      }
      ...
      function hapus(judul, id) {
        ...
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_admin/hapusforum/') ?>" + id);
        }else{
          return false;
        }
      }
