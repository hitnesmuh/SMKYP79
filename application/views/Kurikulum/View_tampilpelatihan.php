        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                  <h3 class="m-0 font-weight-bold text-primary">Daftar Pelatihan Anda</h3>
                </div>
                <div class="col-auto">
                    <a href="<?php echo site_url('kurikulum/tambahpelatihan') ?>" class="btn btn-sm btn-primary btn-icon-split">
                        <span class="icon">
                  ...
                  <tbody>
                    <?php
                      ...
                      foreach ($modul as $datmodul) {
                          if ($datmodul->id_peminta == $this->session->userdata('id')) {
                    ?>
                    <tr>
                      ...
                      <td class="align-middle">
                        <?php 
                          if ($datmodul->status == 0) {
                            echo "Sedang menunggu acc admin";
                          }elseif ($datmodul->status == 1) {
                            echo "Sudah di acc admin";
                          }else{
                            echo "Pelatihan di tolak admin";
                          }
                        ?>
                      </td>
  ...
  <script>
    ...
    ?>
      function hapus(judul, id) {
        ...
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_kurikulum/hapusmodul/') ?>" + id);
        }else{
          return false;
        }
      }
