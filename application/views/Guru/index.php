...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                  <h3 class="m-0 font-weight-bold text-primary">Selamat Datang <?php echo $this->session->nama; ?></h3>
                </div>
              </div>
            </div>
            <div class="card-body">
  ...
  <script>
    ...
    <?php
      foreach ($guru as $datguru) {
    ?> 
      function hapus(nama) {
        var konfirmasi = confirm("Apakah Anda yakin akan menghapus " + nama);
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_admin/hapusguru/'.$datguru->id) ?>");
        }else{
          return false;
        }
      }
