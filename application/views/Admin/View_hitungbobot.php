        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                  <h3 class="m-0 font-weight-bold text-primary">Hitung Bobot</h3>
                </div>
              </div>
              <span><?php echo $this->session->flashdata('message'); ?></span>
            </div>
            <div class="card-body">
              <p class="text-justify">Hitung bobot adalah penghitungan bobot tiap kata dalam suatu dokumen. Prosesnya terdiri dari menghilangkan kata umum (<i>stopword</i>) pada dokumen dan melakukan <i>stemming</i> tiap kata dalam dokumen, setelah itu jumlah tiap kata akan dimasukkan ke rumus TF-IDF untuk dihitung nilai bobotnya.</p>
              <div class="table-responsive">
                <table class="table table-striped" id="dataTable1" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      <td class="align-middle text-center" width="30">1</td>
                      <td class="align-middle">Pelatihan</td>
                      <td class="align-middle text-center">
                        <a href="<?php echo site_url('admin/hitungpelatihan') ?>" class="btn btn-sm btn-info btn-icon-split">
                            <span class="icon">
                    ...
                    <tr>
                      <td class="align-middle text-center" width="30">2</td>
                      <td class="align-middle">Materi</td>
                      <td class="align-middle text-center">
                        <a href="<?php echo site_url('admin/hitungmateri') ?>" class="btn btn-sm btn-info btn-icon-split">
                            <span class="icon">
                                <i class="fa fa-calculator"></i>
                            </span>
                            <span class="text">
