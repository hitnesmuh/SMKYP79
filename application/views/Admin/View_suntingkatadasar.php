...
<head>
  ...
  <title>Sunting Kata Dasar <?php echo $katadasar->term; ?></title>
              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                    ...
                    <div class="row">
                      <div class="col">
                        <h3 class="align-middle m-0 font-weight-bold text-primary">
                          Sunting Kata Dasar <?php echo $katadasar->term; ?>
                        </h3>
                      </div>
                      <div class="col-auto">
                        <a href="<?php echo site_url('admin/katadasar') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                          <span class="icon">
                  ...
                  <div class="card-body pb-2">
                    <form action="<?php echo site_url('Controller_admin/simpansuntingkatadasar/'.$katadasar->id) ?>" method="POST">
                      <div class="row form-group">
                          <label class="col-md-4 text-md-right" for="username">Term</label>
                          <div class="col-md-8">
                            <input type="hidden" name="cek" value="<?php echo $katadasar->term ?>">
                            <input type="text" id="username" autocomplete="off" value="<?php echo $katadasar->term ?>" name="term" class="form-control" placeholder="Masukkan kata yang memiliki imbuhan" required>
                          </div>
                      </div>
                      <div class="row form-group">
                        <label class="col-md-4 text-md-right" for="password_baru">Stem</label>
                        <div class="col-md-8">
                          <div class="input-group">
                            <?php
                              $link = file('./assets/tfidf/katadasar.txt');
                            ?>
                            <select id="provinsi" class="custom-select" name="stem">
                              <option selected value="<?php echo $katadasar->stem ?>"><?php echo $katadasar->stem; ?></option>
                              <?php foreach ($link as $kata) { ?>
                                <option value="<?php echo $kata ?>"><?php echo $kata; ?></option>
                              <?php } ?>
                           </select>
                          </div>
                        </div>
