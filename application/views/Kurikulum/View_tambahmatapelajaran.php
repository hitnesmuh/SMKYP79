              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body pb-2">
                    <form action="<?php echo site_url('kurikulum/simpanmatapelajaran') ?>" method="post">
                      <div class="row form-group">
                        <label class="col-md-4 text-md-right" for="password_baru">Nama</label>
                        <div class="col-md-8">
                          <input id="judul" type="text" autocomplete="off" class="form-control" name="nama" placeholder="Nama Mata Pelajaran" required>
                        </div>
                      </div>
