              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body pb-2">
                    <form action="<?php echo site_url('Controller_admin/simpankatadasar') ?>" method="POST">
                      <div class="row form-group">
                          <label class="col-md-4 text-md-right" for="username">Term</label>
                          <div class="col-md-8">
                            <input type="text" id="username" autocomplete="off" name="term" class="form-control" placeholder="Masukkan kata yang memiliki imbuhan" required>
                          </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-md-8">
                          <div class="input-group">
                            ...
                            ?>
                            <select id="katadasar" class="custom-select" name="stem">
