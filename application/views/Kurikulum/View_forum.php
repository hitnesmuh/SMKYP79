          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                ...
                <div class="col-auto">
                    <a href="<?php echo site_url('kurikulum/tambahforum') ?>" class="btn btn-sm btn-primary btn-icon-split">
                      <span class="icon">
  ...
  <script>
    ...
    ?>
      function hapus(judul, id) {
        ...
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_kurikulum/hapusforum/') ?>" + id);
        }else{
          return false;
        }
      }
