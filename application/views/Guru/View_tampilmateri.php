          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                ...
                <div class="col-auto">
                    <a href="<?php echo site_url('guru/matapelajaranguru') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                      <span class="icon">
                    ...
                    <a href="<?php echo site_url('guru/tambahmateri/'.$matapelajaran->id) ?>" class="btn btn-sm btn-primary btn-icon-split">
                      <span class="icon">
