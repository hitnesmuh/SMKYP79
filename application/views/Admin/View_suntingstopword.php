...
<head>
  ...
  <title>Sunting Stopword <?php echo $stopword->kata; ?></title>
              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                    ...
                    <div class="row">
                      <div class="col">
                        <h3 class="align-middle m-0 font-weight-bold text-primary">
                          Sunting <i>Stopword</i> <?php echo $stopword->kata; ?>
                        </h3>
                      </div>
                      <div class="col-auto">
                  ...
                  <div class="card-body pb-2">
                    <form action="<?php echo site_url('Controller_admin/simpansuntingstopword/'.$stopword->id) ?>" method="POST">
                      <div class="row form-group">
                          <label class="col-md-4 text-md-right" for="username">Kata</label>
                          <div class="col-md-8">
                            <input type="hidden" name="cek" value="<?php echo $stopword->kata ?>">
                            <input type="text" id="username" autocomplete="off" value="<?php echo $stopword->kata ?>" name="kata" class="form-control" placeholder="Masukkan kata stopword" required>
                          </div>
                      </div>
