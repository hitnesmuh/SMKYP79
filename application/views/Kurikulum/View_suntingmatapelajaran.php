...
<head>
  ...
  <title>Sunting Mata Pelajaran</title>
              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                    ...
                    <div class="row">
                      <div class="col">
                        <h3 class="align-middle m-0 font-weight-bold text-primary">
                          Sunting Mata Pelajaran <?php echo $matapelajaran->nama; ?>
                        </h3>
                      </div>
                      <div class="col-auto">
                  ...
                  <div class="card-body pb-2">
                    <form action="<?php echo site_url('Controller_kurikulum/simpansuntingmatapelajaran/'.$matapelajaran->id) ?>" method="post">
                      <div class="row form-group">
                        <label class="col-md-4 text-md-right" for="password_baru">Nama</label>
                        <div class="col-md-8">
                          <input type="hidden" name="cek" value="<?php echo $matapelajaran->nama ?>">
                          <input id="judul" type="text" autocomplete="off" value="<?php echo $matapelajaran->nama ?>" class="form-control" name="nama" placeholder="Nama Mata Pelajaran" required>
                        </div>
                      </div>
