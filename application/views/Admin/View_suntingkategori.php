              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                    ...
                    <div class="row">
                      <div class="col">
                        <h3 class="align-middle m-0 font-weight-bold text-primary">
                          Sunting Kategori <?php echo $kategori->nama; ?>
                        </h3>
                      </div>
                      <div class="col-auto">
                        <a href="<?php echo site_url('admin/kategori') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                          <span class="icon">
                  ...
                  <div class="card-body pb-2">
                    <form action="<?php echo site_url('Controller_admin/simpansuntingkategori/'.$kategori->id) ?>" method="POST">
                      <div class="row form-group">
                          <label class="col-md-4 text-md-right" for="username">Nama</label>
                          <div class="col-md-8">
                              <input type="hidden" value="<?php echo $kategori->nama?>" name="cek">
                              <input type="text" autocomplete="off" value="<?php echo $kategori->nama?>" id="nama" name="nama" class="form-control" placeholder="Nama Kategori" required>
                          </div>
                      </div>
