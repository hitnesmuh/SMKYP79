...
<head>
  ...
  <title>Sunting Materi <?php echo $matapelajaran->nama; ?></title>
              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <div class="row">
                      <div class="col">
                        <h3 class="align-middle m-0 font-weight-bold text-primary">
                          Sunting Materi <?php echo $materi->nama; ?>
                        </h3>
                      </div>
                      <div class="col-auto">
                    ...
                    Mata Pelajaran <?php echo $matapelajaran->nama; ?>
                  </div>
                  <div class="card-body pb-2">
                    <form enctype="multipart/form-data" method="post" id="submitfile">
                      <div class="row form-group">
                        ...
                        <div class="col-md-8">
                          <input type="hidden" name="cek" value="<?php echo $materi->nama ?>">
                          <input type="hidden" name="id_mapel" value="<?php echo $matapelajaran->id ?>">
                          <input id="judul" type="text" autocomplete="off" class="form-control" name="nama" placeholder="Nama Materi" value="<?php echo $materi->nama ?>" required>
                        </div>
                      </div>
                      <hr>
                      <div class="row form-group">
                        ...
                        <div class="col-md-8">
                          <textarea class="form-control" id="deskripsi" name="uraian" placeholder="Tulis uraian singkat materi yang akan Anda unggah" rows="4" required><?php echo $materi->uraian_singkat; ?></textarea>
                        </div>
                      </div>
                      <div class="row form-group">
        ...
        form.addEventListener('submit', function(e){
            ...
            if(isi.files.length != 0){
              ...
              if (konfirmasi) {
                ...
                xhr.open("POST","<?php echo site_url('Controller_guru/simpansuntingmateri/'.$materi->id.'/'.$matapelajaran->id) ?>", true);
                xhr.send(fd);
