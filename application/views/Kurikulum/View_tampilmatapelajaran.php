        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                  <h3 class="m-0 font-weight-bold text-primary">Daftar Mata Pelajaran</h3>
                </div>
                <div class="col-auto">
                    <a href="<?php echo site_url('kurikulum/tambahmatapelajaran') ?>" class="btn btn-sm btn-primary btn-icon-split">
                        <span class="icon">
                ...
                <table class="table table-striped" id="dataTable1" width="100%" cellspacing="0">
                  <thead class="text-center">
                    <tr>
                      ...
                      <th class="align-middle">Materi</th>
                  ...
                  <tbody>
                    <?php
                      $no = 1;
                      foreach ($matapelajaran as $datmapel) {
                    ?>
                    <tr>
                      <td class="align-middle text-center" width="30"><?php echo $no; ?></td>
                      <td class="align-middle"><?php echo $datmapel->nama; ?></td>
                      <td class="align-middle text-center">
                        <a href="<?php echo site_url('kurikulum/tampilmateri/'.$datmapel->id) ?>" class="btn btn-sm btn-info btn-icon-split">
                            <span class="icon">
                                <i class="fa fa-eye"></i>
                            </span>
                            <span class="text">
                      ...
                      <td class="align-middle text-center">
                        <a href="#" onclick="hapus('<?php echo $datmapel->nama ?>', '<?php echo $datmapel->id ?>')" class="btn btn-danger btn-circle m-1"><i class="fa fa-fw fa-trash"></i></a>
                        <a href="<?php echo site_url('kurikulum/suntingmatapelajaran/'.$datmapel->id) ?>" class="btn btn-success btn-circle m-1"><i class="fa fa-fw fa-edit"></i></a>
                      </td>
                    </tr>
                    <?php
                        $no++; }
  ...
  <script>
    ...
    ?>
      function hapus(judul, id) {
        var konfirmasi = confirm("Apakah Anda yakin akan menghapus mata pelajaran " + judul);
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_kurikulum/hapusmatapelajaran/') ?>" + id);
        }else{
          return false;
        }
      }
