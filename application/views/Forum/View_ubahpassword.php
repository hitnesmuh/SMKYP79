          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-8">
              <div class="card shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                  <form action="<?php echo site_url('Controller_forum/simpanubahpassword/'.$this->session->userdata('id')) ?>" method="POST">
                    <div class="row form-group">
                      <label class="col-md-3 text-md-right" for="password_lama">Password Lama</label>
                      <div class="col-md-9">
                        <div class="input-group">
                          <input id="pass" type="password" autocomplete="off" class="form-control" name="pass" placeholder="Masukkan Password Lama" onchange="tombol()" required>
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                          <input id="pass2" type="password" autocomplete="off" class="form-control" name="pass2" placeholder="Masukkan Password Baru" onchange="tombol()" required>
                          <div class="input-group-append">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                          <input id="pass3" type="password" autocomplete="off" class="form-control" name="pass3" placeholder="Masukkan Kembali Password Baru" onchange="tombol()" required>
                          <div class="input-group-append">
