        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                  <h3 class="m-0 font-weight-bold text-primary">Daftar Kategori</h3>
                </div>
                  <div class="col-auto">
                    <a href="<?php echo site_url('admin/tambahkategori') ?>" class="btn btn-sm btn-primary btn-icon-split">
                        <span class="icon">
                ...
                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle"><?php echo $datkategori->nama; ?></td>
                      <td class="align-middle text-center">
                        <a href="#" onclick="hapus('<?php echo $datkategori->nama ?>', '<?php echo $datkategori->id ?>')" class="btn btn-danger btn-circle m-1"><i class="fa fa-fw fa-trash"></i></a>
                        <a href="<?php echo site_url('admin/suntingkategori/'.$datkategori->id) ?>" class="btn btn-success btn-circle m-1"><i class="fa fa-fw fa-edit"></i></a>
                      </td>
                    </tr>
                    <?php
                        $no++; }
  ...
  <script>
    ...
    ?> 
      function hapus(nama, id) {
        var konfirmasi = confirm("Apakah Anda yakin akan menghapus kategori "+nama);
        if (konfirmasi){
          window.location.replace("<?php echo site_url('Controller_admin/hapuskategori/') ?>"+id);
        }else{
          return false;
        }
      }
